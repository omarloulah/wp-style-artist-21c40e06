<?php
/**
 * Archive Template (Categories, Tags, etc.)
 *
 * @package TechPolse
 */
    ...
    <div class="container py-8">
        ...
        <div class="archive-header">
            ...
            <p class="archive-description">
                ...
                printf(
                    _n('%s article in this category', '%s articles in this category', $total, 'techpolse'),
        ...
        <div class="category-tabs">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="category-tab">
            ...
            <div class="articles-column">
                ...
                <?php else : ?>
                    <div class="no-posts" style="text-align: center; padding: 4rem 0;">
                        <p style="color: var(--muted-foreground);"><?php esc_html_e('No articles in this category yet', 'techpolse'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
